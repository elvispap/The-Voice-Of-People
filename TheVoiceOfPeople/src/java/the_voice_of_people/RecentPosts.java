...
public class RecentPosts extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            Date date = new Date();
            String current_time = dateFormat.format(date);			// the current time now!
		...
		try {
		    ...
		    out.append("<recents_posts>");
                    //querry = "select * from post where time_date <='"+ current_time +"'";
                    querry = "select * from post order by time_date ";
